...
const sections = [
  {
    ...
    description: "Learn the fundamentals and set up your first nexar project.",
    links: [
  ...
  {
    title: "Community",
    description: "Get involved and contribute to nexar.",
    links: [
    ...
    <div className="py-10">
      ...
      <div className="mb-10">
        <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-sm font-medium text-slate-600 shadow-sm">
          ...
          nexar v0.2.7 Documentation
        </div>
        <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950">
          Build enterprise Next.js applications
        </h1>
        <p className="mt-3 text-lg text-slate-600 max-w-2xl">
          Everything you need to build with nexar — from getting started to advanced patterns,
