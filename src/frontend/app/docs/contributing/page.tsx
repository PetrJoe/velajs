...
export default function ContributingPage() {
  return (
    <div className="py-10">
      ...
      <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950">Contributing to nexar</h1>
      ...
      <Section title="Development Setup">
        ...
        <CodeBlock>{`git clone https://github.com/nexar/nexar.git
cd nexar
npm install
cp .env.example .env
npm run db:migrate
...
npm run lint          # ESLint`}</CodeBlock>
      ...
      <Section title="Getting Help">
        ...
        <ul className="mt-4 list-inside list-disc space-y-2 text-sm text-slate-600">
          <li>Open a <a href="https://github.com/nexar/nexar/discussions" className="font-medium text-slate-900 underline" target="_blank" rel="noopener noreferrer">GitHub Discussion</a></li>
