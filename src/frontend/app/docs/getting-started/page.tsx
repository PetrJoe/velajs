...
export default function GettingStartedPage() {
  return (
    <div className="py-10">
      ...
      <h1 className="mt-4 text-4xl font-bold tracking-tight text-slate-950">Build your first nexar application</h1>
      ...
      <Section title="1. Create a new project">
        <p>Scaffold a new nexar project using the CLI:</p>
        <CodeBlock>{`npx nexar create my-app
cd my-app
