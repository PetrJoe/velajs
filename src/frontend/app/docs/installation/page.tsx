  ...
  return (
    <div className="py-10">
      ...
      <p className="mt-3 text-lg text-slate-600 max-w-2xl">
        Complete guide to setting up your nexar environment, from prerequisites to production configuration.
      </p>
      ...
      <Section title="Quick Start">
        ...
        <CodeBlock>{`npx nexar create my-project
cd my-project
...
npm run dev`}</CodeBlock>
        <p>This starts a PostgreSQL instance on port 5432. The database name is <InlineCode>nexar</InlineCode>
