          ...
          <div className="relative mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                nexar is a fullstack starter that brings structure, generators, PostgreSQL workflows, typed validation, and Tailwind UI conventions to serious Next.js projects.
              </p>
