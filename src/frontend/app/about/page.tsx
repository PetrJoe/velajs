  ...
  return (
    <AppShell>
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-semibold tracking-tight text-slate-950">About velajs</h1>
        <p className="mt-4 text-lg leading-8 text-slate-600">
          velajs is a fullstack starter kit built on Next.js, Knex, PostgreSQL, Zod, and Tailwind CSS.
        ...
        <h2 className="mt-12 text-2xl font-semibold tracking-tight text-slate-950">Why velajs?</h2>
        <p className="mt-4 text-base leading-7 text-slate-600">
          Every team eventually builds scaffolding around their Next.js projects — CLI generators, database layers,
          auth setup, UI primitives, and deployment config. velajs does this from day one, so you can focus on
        ...
        <p className="mt-4 text-base leading-7 text-slate-600">
          velajs is open source and available under the MIT license.
        </p>
      </main>
    </AppShell>
  );
